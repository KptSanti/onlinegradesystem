...
<div class="container">
<h3 class="fw-bold mb-3">List of Class</h3>
    <form action="#.php" Method="POST"> 

		<table id="singlewithnum" class="table table-hover table-bordered table-striped" cellspacing="0" width="100%">
		 	...
		 	loadresult();
	  		...
	  		function loadresult(){
				...
				foreach ($cur as $result) {
			  		...
			  		echo '<td><a href="index.php?view=class&classId='.$result->CLASS_ID.'"><span class="btn btn-secondary ">View List</span></a></td>';
			  	 	echo '</tr>';
		  		}
		  	} 
	  	?>
