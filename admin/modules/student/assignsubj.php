	...
	<caption><h3 align="left">List of Course</h3></caption>		
		<div class="well">
				...
				<div class="btn-group mt-2">
				  <a href="index.php?view=subject&studentId=<?php echo (isset($studentId)) ? $studentId : 'ID' ;?>&cid=<?php echo (isset($courseid)) ? $courseid : 'cid' ;?>&sy=<?php echo (isset($sy)) ? $sy : 'sy' ;?>" class="btn btn-primary"><span class="glyphicon glyphicon-back"></span>Back</a>
