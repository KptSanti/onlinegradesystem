              ...
              <div class="card-body ">
              <h3 class="fw-bold mb-3">Add New Student</h3>
           ...
           <div class="col-md-4">
            <div class="form-group">
                ...
                "bday">Birth Date</label> 
                    ...
                    <input class="form-control" size="11" type="text" value="" placeholder="yyyy-mm-dd"readonly name="bday" id="bday">
    ...
    <fieldset>
      <legend class="fw-bold">Secondary Details</legend>
 ...
 <!--sdsds-->
    ...
    <fieldset>
      <legend class="mt-2 fw-bold">Other Details</legend>
