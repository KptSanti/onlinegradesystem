	...
	<div class="panel panel-primary">
	  ...
	  <div class="panel-body">
	   <div class="row" >	   
		...
		<br>
		<h3 class="mb-3">List of Subjects</h3>
				  ...
				  <tbody>
				  	<?php
						...
						//	echo '<td align="center">'. $result->UNIT.'</td>';
							...
							echo '<td><a href="index.php?view=class&id='.$result->CLASS_ID.'&instructorId='.$result->INST_ID.'"><span class="btn btn-secondary">View</span></a></td>';
	  		...
	  		<!--	<tfoot>
				...
				<div class="btn-group mt-2">
				  <a href="index.php" class="btn btn-primary">Back</a>
				   <a href="index.php?view=assign&instructorId=<?php  echo (isset($_GET['instructorId'])) ? $_GET['instructorId']: 'ID' ; ?>" class="btn btn-primary"><span class="glyphicon glyphicon-plus-sign"></span>  Assign Subjects</a>
