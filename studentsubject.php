		  ...
		  <!-- <form class="form-horizontal span4" action="#.php" method="POST"> -->
					<div class="panel panel-primary">
					  <div class="panel-heading">
					    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Report card of Student </h3>
					  </div>
			           ...
			           <div class="container">
					    ...
					    <span id="printout">
				           <table > 
						     ...
						     <tbody>
						     	<tr>
						     		...
						     		<b>Course/Year : </b><?php echo (isset($studcourse)) ? $studcourse->COURSE_DESC : 'Department' ;?>
						     		</p></td>
					     ...
					     <form class="form-horizontal span4" action="controller.php?action=delsubj&studentId=<?php echo $_GET['studentId']; ?>&cid=<?php echo $_GET['cid']; ?>&sy=<?php echo $_GET['sy']; ?>" method="POST">					    
								<table id="singletwos" class="table table-bordered table-striped" cellspacing="0" id="table">
						...
						<div class="btn-group">
							<a href="index.php?page=3" class="btn btn-primary">Back</a>
